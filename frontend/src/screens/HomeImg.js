    ...
    <Carousel activeIndex={index} onSelect={handleSelect}>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="homeimg-content">
            “If you love mountains, you will never get bored, because there is
            always a new mountain to explore.”
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Goa , India</h3>
          <p className="homeimg-content">
            "Holiday Packages in Goa for an Ideal Family Vacation"
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="homeimg-content">
            “Hanging out in Agra, capturing some beautiful architecture around
            the city. Taj Mahal.”
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Jaipur , India</h3>
          <p className="homeimg-content">
            “Jaipur is the finest jewelry ever created on earth, where king was
            the jeweler and bricks his gems.”
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="homeimg-content">
            “After all there is a reason why Kerala is called God's own
            country.From the backwaters of Kumarakom and Alleppey”
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="homeimg-content">
            “Ooty is one of the country's most beautiful and culturally rich
            cities.”
          </p>
        </Carousel.Caption>
      </Carousel.Item>
